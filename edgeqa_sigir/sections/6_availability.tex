...
\textbf{Access link (to be filled for submission):} \texttt{\{REPOSITORY\_URL\}}.
...
In addition to the live repository, we archive the submission snapshot (code, prompts, configs, and data metadata) with a DOI and provide checksums for all released files.
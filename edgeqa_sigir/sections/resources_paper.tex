...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{IR exports:} BEIR-style test collections (queries/corpus/qrels) created from evidence mappings~\citep{thakur2021beir}.
\end{itemize}
...
We connect abstention to selective classification via risk--coverage analysis~\citep{geifman2017selective} and adopt robustness diagnostics inspired by contrast sets and behavioral test suites~\citep{gardner2020contrastsets,ribeiro2020checklist}.

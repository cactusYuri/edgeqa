...
EdgeCoverBench also achieves 1.00 meaning preservation on paraphrases and 1.00 validity for near-miss labels on both corpora; full audit sheets and scripts are released with the resource.
\input{tables/tab_human_audit_edgeqa}

\section{Availability (reviewer access)}
\label{sec:res_avail}

\textbf{Resource link (to be filled):} \texttt{\{HUGGINGFACE\_DATASET\_URL\}}.
...
\textbf{Code link (to be filled):} \texttt{\{CODE\_REPO\_URL\}} (Apache-2.0).
